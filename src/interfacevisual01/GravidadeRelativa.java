 ...
 * @author 884648
 */
public class GravidadeRelativa extends javax.swing.JFrame {

    /**
     * Creates new form GravidadeRelativa
     */
    public GravidadeRelativa() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Escolha o planeta:");
        ...
        jLabel1.setText("Gravidade Relativa");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GravidadeRelativa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GravidadeRelativa().setVisible(true);
            }
        });
    }
